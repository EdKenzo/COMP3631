...
class colourIdentifier(Node):
    ...
    def callback(self, data):
        try:
            ...
            hsv_red_lower2 = np.array([0+self.sensitivity, 255, 255])
            hsv_red_upper1 = np.array([160-self.sensitivity, 100, 100])
            hsv_red_upper2 = np.array([160+self.sensitivity, 255, 255])
